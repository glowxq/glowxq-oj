 ...
 */
@Data
@Schema(description = "Tenant添加DTO")
public class TenantCreateDTO implements BaseDTO {
   ...
   private String customDomain;
    ...
    public Tenant buildEntity() {
       Tenant tenant = BeanCopyUtils.copy(this, Tenant.class);
       tenant.setTenantId(TenantUtils.generateTenantId());
       return tenant;
    }
}