...
public class CodeModelBuilder {
    ...
    public CodeModelBuilder builderBaseInfo(GeneratorDetailVO detailVO) {
        ...
        model.put("moduleName", detailVO.getGeneratorInfo().getModuleName());
        ...
        model.put("businessPath", AppUtils.getBusinessPath());
        model.put("businessApiPrefix", AppUtils.getBusinessApiPrefix());
    ...
    public CodeModelBuilder builderVue(GeneratorDetailVO detailVO) {
        String className = detailVO.getBaseInfo().getClassName();
        String interfacePkg = SEPARATOR + "api" + SEPARATOR + "interface" + SEPARATOR + AppUtils.getBusinessPath() + SEPARATOR + detailVO.getGeneratorInfo()
                                                                                                                                         .getModuleName();
        ...
        String modulesPkg = SEPARATOR + "api" + SEPARATOR + "modules" + SEPARATOR + AppUtils.getBusinessPath() + SEPARATOR + detailVO.getGeneratorInfo()
                                                                                                                                     .getModuleName();
        model.put("modulesPkg", modulesPkg);
        model.put("modulesClassName", detailVO.getGeneratorInfo().getBusinessName());

        String indexPkg = SEPARATOR + "views" + SEPARATOR + AppUtils.getBusinessPath() + SEPARATOR + detailVO.getGeneratorInfo().getModuleName() + SEPARATOR
