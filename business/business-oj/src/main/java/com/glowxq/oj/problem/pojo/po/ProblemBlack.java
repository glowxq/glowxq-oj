...
*/
@Data
@Table(value = "problem_black", onInsert = EntityChangeListener.class, onUpdate = EntityChangeListener.class)
@Schema(description = "题目黑名单")
public class ProblemBlack implements BaseEntity {
