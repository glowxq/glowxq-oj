 ...
 */
@Data
@Schema(description = "Topic查询DTO")
public class TopicListDTO extends PageQuery implements BaseDTO {
    ...
    @InEnum(enumClass = TopicType.class)
    private String topicType;

    @Schema(description = "是否非比赛类型")
    private Boolean isNotContest;
