...
@Slf4j
@Component
public class OtherProblemBatchUploadHandler extends BaseProblemBatchUploadHandler {

    public OtherProblemBatchUploadHandler(ProblemUploadFactory problemUploadFactory) {
