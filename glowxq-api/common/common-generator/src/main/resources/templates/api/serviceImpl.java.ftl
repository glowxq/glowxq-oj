...
<#list columns as field>
    <#if field.isQuery == "1">
        ...
        <#if field.queryType == "EQ">
            wrapper.eq(${poClassName}::get${field.upCamelField}, dto.get${field.upCamelField}(), Utils.isNotNull(dto.get${field.upCamelField}()));
        <#-- 不等于 -->
        <#elseif field.queryType == "NEQ">
            wrapper.ne(${poClassName}::get${field.upCamelField}, dto.get${field.upCamelField}(), Utils.isNotNull(dto.get${field.upCamelField}()));
        <#-- 大于 -->
        <#elseif field.queryType == "GT">
            wrapper.gt(${poClassName}::get${field.upCamelField}, dto.get${field.upCamelField}(), Utils.isNotNull(dto.get${field.upCamelField}()));
        <#-- 小于 -->
        <#elseif field.queryType == "LT">
            wrapper.lt(${poClassName}::get${field.upCamelField}, dto.get${field.upCamelField}(), Utils.isNotNull(dto.get${field.upCamelField}()));
        <#-- 区间查询 -->
        <#elseif field.queryType == "BETWEEN">
            wrapper.between(${poClassName}::get${field.upCamelField},
            dto.get${field.upCamelField}Start(),
            dto.get${field.upCamelField}End(),
            Utils.isNotNull(dto.get${field.upCamelField}Start()) && Utils.isNotNull(dto.get${field.upCamelField}End()));
        <#-- 大于等于 -->
        <#elseif field.queryType == "GTE">
            wrapper.gte(${poClassName}::get${field.upCamelField}, dto.get${field.upCamelField}(), Utils.isNotNull(dto.get${field.upCamelField}()));
        <#-- 小于等于 -->
        <#elseif field.queryType == "LTE">
            wrapper.lte(${poClassName}::get${field.upCamelField}, dto.get${field.upCamelField}(), Utils.isNotNull(dto.get${field.upCamelField}()));
        <#-- 模糊查询 -->
        <#elseif field.queryType == "LIKE">
            wrapper.like(${poClassName}::get${field.upCamelField}, dto.get${field.upCamelField}(), Utils.isNotNull(dto.get${field.upCamelField}()));
        </#if>
    </#if>
</#list>
    return wrapper;
