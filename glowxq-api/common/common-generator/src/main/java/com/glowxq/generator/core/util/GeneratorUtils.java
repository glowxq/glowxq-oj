package com.glowxq.generator.core.util;
...
public class GeneratorUtils {
    ...
    public static GeneratorTable initGeneratorTable(TableResult table) {
        ...
        generatorTable.setModuleName(table.buildModuleName());
    ...
    public static GeneratorTableColumn initColumnField(TableColumResult column, Long tableId, int i) {
        ...
        String dataType = getDbType(column.getRemoveUnsignedType());
        String columnName = column.getColumnName();
        tableColumn.setTableId(tableId);
        tableColumn.setColumnName(columnName);
        tableColumn.setColumnComment(column.getColumnComment());
        tableColumn.setColumnType(column.getRemoveUnsignedType());
        ...
        setHtmlAndJavaType(dataType, column.getRemoveUnsignedType(), tableColumn);
    ...
    private static void setHtmlAndJavaType(String dataType, String columnType, GeneratorTableColumn tableColumn) {
        switch (dataType.toUpperCase()) {
            ...
            case "DATETIME":
                ...
                break;
            case "TINYINT":
                tableColumn.setJavaType(GeneratorConstants.TYPE_BOOLEAN);
                tableColumn.setHtmlType(GeneratorConstants.HTML_SWITCH);
                tableColumn.setSearchType(GeneratorConstants.HTML_SWITCH);
                tableColumn.setQueryType(GeneratorConstants.QUERY_EQ);
                break;
            case "SMALLINT":
            case "MEDIUMINT":
