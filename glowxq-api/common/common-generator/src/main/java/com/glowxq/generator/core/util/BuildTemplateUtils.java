...
import com.glowxq.generator.core.builder.java.*;
import com.glowxq.generator.core.builder.vue.FormCodeBuilder;
import com.glowxq.generator.core.builder.vue.IndexCodeBuilder;
import com.glowxq.generator.core.builder.vue.InterfaceCodeBuilder;
import com.glowxq.generator.core.builder.vue.ModulesCodeBuilder;
...
public class BuildTemplateUtils {
    ...
    public static List<AbstractCodeGenerationTemplate> getApiTemplates(FreeMarkerConfigurer configurer, String rootPath, GeneratorDetailVO detailVO,
        ...
        return switch (detailVO.getGeneratorInfo().generateTypeEnum()) {
            ...
            case vue -> Collections.emptyList();
