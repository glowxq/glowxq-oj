...
@AllArgsConstructor
@Getter
public enum SubmitJudgeType implements BaseType {
     ...
     * @return
     */
    public static SubmitJudgeType matchCode(String code) {
        for (SubmitJudgeType sceneType : SubmitJudgeType.values()) {
